let eventmgmt_json = `{"mousepos":{"at_lmbd":{"x":583,"y":382},"at_lmbu":{"x":761,"y":623},"current":{"x":1029,"y":358}},"object_clicked_on":null,"object_origin":[{"x":-9.056467835591203,"y":33.06268056735285},{"x":-9,"y":27},{"x":-4,"y":31}],"viewport_origin":{"x":1016.3988929579473,"y":759.0225655393614},"pressed":{"spacebar":false,"ctrl":false,"shift":false,"leftmousebutton":false},"selectionrect":null,"input_selected":null,"objIncrement":564,"persistent_choices":{"draw_grid":false,"draw_help_text":true,"force_pan":false,"page_bgcolor":"rgba(0,41,78,1)","page_gridcolor":"rgba(0,59,111,1)"},"input_object":null}`; 
eventmgmt = JSON.parse(eventmgmt_json);
let viewport_json = `{"x":1152.4567929663435,"y":806.4854502781945,"blocksize":8.52733307643028}`;
